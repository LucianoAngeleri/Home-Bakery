...
END$$
DELIMITER ;
/*En caso de actualizacion de datos, creamos triggers para registrar los cambios de las tablas de VENTAS y COMPRAS*/
/*Creamos la tabla de backup de las tablas COMPRA y VENTA*/
CREATE TABLE CAMBIOS_COMPRA (
	ID_UP_Compra INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	ID_Compra INT NOT NULL,
    Usuario_Registro VARCHAR(50) NOT NULL,
    Fecha_Registro DATE NOT NULL,
    Hora_Registro TIME NOT NULL,
...
CREATE TABLE CAMBIOS_VENTA (
	ID_UP_Venta INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	ID_Venta INT NOT NULL,
    Usuario_Registro VARCHAR(50) NOT NULL,
    Fecha_Registro DATE NOT NULL,
    Hora_Registro TIME NOT NULL,
...
/*Creación del trigger despues de la */
DELIMITER $$
CREATE TRIGGER `tr_update_COMPRA`
AFTER UPDATE ON COMPRA
FOR EACH ROW
BEGIN
    INSERT INTO CAMBIOS_COMPRA(
		Usuario, 
		Fecha_Registro, 
		Hora_Registro, 
		Accion, 
